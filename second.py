...
class main:
    ...
    def login(self):
        ...
        if result:
            ...
            #top.right.pack(side=RIGHT)            top.image=ImageTk.PhotoImage(Image.open("hospital4.jpg"))
            top.panel=Label(top.left,image=top.image)
            top.panel.pack()

            top.heading = Label(top.left,text="sit 221 Hospital",font=('arial 40 bold'),bd=3,fg='black')
            ...
            def next():
                ...
                if(top.val1=='' or top.val2=='' or top.val3=='' or top.val4=='' or top.val5=='' or top.val6==''):
                   ms.showinfo("warning","fill all the required details")
                    ...
                    c = db.cursor()
                    sql="INSERT INTO appointment(name,age,gender,address,phone,time)VALUES(%s, %s, %s, %s, %s, %s)"
